...
print("Starting transformation pipeline for TNP Trips...")

# 1. CONFIGURATION 
BRONZE_CONTAINER = "bronze"
SILVER_CONTAINER = "silver"
BRONZE_BLOB_NAME = "tnp_trips_sample.json"  # CHANGED
SILVER_BLOB_NAME = "clean_tnp_trips.parquet" # CHANGED
...
# CRITICAL CHANGE: TNP's specific column names 
...
try:
    with db_engine.connect() as conn:
        # CRITICAL CHANGE: Use a different temp table name 
        temp_table_name = 'temp_tnp_locations'
...
try:
    ...
    print("...Upload complete.")
    print("TNP transformation pipeline finished successfully.")
