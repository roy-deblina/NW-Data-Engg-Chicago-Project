...
print("Starting extraction for Public Health Stats...")

# 1. CONFIGURATION 
SODA_DOMAIN = "data.cityofchicago.org"
SODA_DATASET_ID = "iqnk-2tcu"  #  Public Health Stats ID
...
try:
    ...
    print("Public Health Stats extraction finished successfully.")
