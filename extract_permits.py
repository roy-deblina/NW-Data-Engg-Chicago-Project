...
print("Starting extraction for Building Permits...")

# 1. CONFIGURATION 
SODA_DOMAIN = "data.cityofchicago.org"
SODA_DATASET_ID = "ydr8-5enu"  # Building Permits ID
...
try:
    ...
    # NO LIMIT, WE ARE GETTING ALL 820K+ ROWS
...
try:
    ...
    print("Building Permits extraction finished successfully.")
