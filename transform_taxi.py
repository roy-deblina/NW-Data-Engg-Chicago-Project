...
BRONZE_BLOB_NAME = "taxi_trips_sample.json"
...
try:
    with db_engine.connect() as conn:
        ...
        locations_df.to_sql('temp_trip_locations', conn, if_exists='replace', index=False)
        ...
        conn.execute("DROP TABLE temp_trip_locations;")
